  ...
  items: [
    {
      ...
      imageAlt: 'Ausflex 12ft Tuff Mudder hybrid van hitched and ready to tow',
      floorplan: '/images/plan-tuff-mudder.jpg',
      floorplanAlt: 'Floor plan of the 12ft Tuff Mudder',
      photos: [
        {
          src: '/images/van-tuff-mudder.jpg',
          alt: 'Cutaway 3D render of the Tuff Mudder layout with kitchen and bed',
          caption: '3D layout view',
        },
      ],
    ...
    },
    {
      ...
      image: '/images/photo-little-wonder.jpg',
      imageAlt: 'Ausflex 17ft Little Wonder hybrid in black, parked side-on',
      ...
      photos: [
        {
          src: '/images/van-little-wonder.jpg',
          alt: 'Top-down 3D render of the Little Wonder layout',
          caption: '3D layout view',
        },
        {
    ...
    },
    {
      ...
      photos: [
        {
          src: '/images/van-family-adventurer.jpg',
          alt: 'Top-down 3D render of the Family Adventurer layout with bunks',
          caption: '3D layout view',
        },
        {
    ...
    },
    {
      ...
      image: '/images/photo-fierce-interior-2.jpg',
      imageAlt: 'Fierce Couple Deluxe interior looking toward the living area',
      floorplan: '/images/plan-fierce-couple.jpg',
      floorplanAlt: 'Floor plan of the 19.6ft Fierce Couple Deluxe',
      photos: [
        {
          src: '/images/van-fierce-couple.jpg',
          alt: 'Top-down 3D render of the Fierce Couple Deluxe layout',
          caption: '3D layout view',
        },
        {
    ...
    },
    {
      ...
      image: '/images/photo-extreme.jpg',
      imageAlt: 'Ausflex 21.6ft Extreme Family van on the road in dark grey',
      floorplan: '/images/plan-extreme-family.jpg',
      floorplanAlt: 'Floor plan of the 21.6ft Extreme Family van',
      photos: [
        {
          src: '/images/van-extreme-family.jpg',
          alt: 'Top-down 3D render of the Extreme Family layout',
          caption: '3D layout view',
        },
        {
